  ...
  >
    <div class="p-6 sticky top-16">
      <div class="mb-8">
        ...
        <div
          class="bg-gray-800/40 backdrop-blur-md rounded-2xl p-4 border border-white/5"
        >
          <p
      ...
      >
        ...
        <div class="text-center relative z-10">
          ...
          <p
            class="text-2xl font-black text-transparent bg-clip-text bg-linear-to-r from-yellow-400 to-orange-500"
          >
            42 days
          </p>
...
const navItems = computed(() => {
  ...
  if (user.value?.isAdmin) {
    baseItems.push({ name: "Admin", path: "/admin", icon: "🛡️" });
  }
